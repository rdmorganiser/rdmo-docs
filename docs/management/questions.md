...
* **Copy** (![](../_static/img/icons/copy.png)) a question or questionset. This will open the same modal as update. You can change some of the properties and save the element as a new one. This can save time when creating several similar questions.
